ZONE_HOME = {
    "tl_y": xx.xxxxxx, # Top-Left Latitude (deg) https://www.latlong.net/
...
TOMORROW_API_KEY = "xxxxxxx" # Get an API key from https://tomorrow.io
...
JOURNEY_CODE_SELECTED = "xxx" #bolds your airport code ie PDX
