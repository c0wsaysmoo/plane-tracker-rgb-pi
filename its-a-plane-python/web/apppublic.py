...
def api_calls_log():
    return render_template("api_calls_log.html")

@app.get("/api_calls/log/json")
def api_calls_log_json():
...
def closest_log_page():
    return render_template("log_viewer.html", title="CLOSEST FLIGHT LOGS", mode="flights", data_url="/closest/json")
...
def farthest_log_page():
    return render_template("log_viewer.html", title="FARTHEST FLIGHTS LOGS", mode="flights", data_url="/farthest/json")
