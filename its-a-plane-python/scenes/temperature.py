    ...
    def temperature(self, count):
        ...
        if need_fetch or force_draw:
            ...
            if self._cached_temp and not need_fetch:
                current_temperature, current_humidity, *_ = self._cached_temp
            else:
                # Fetch new values
                current_temperature, current_humidity, current_weather_code = grab_temperature_and_humidity()
                if current_temperature is not None and current_humidity is not None:
                    self._cached_temp = (current_temperature, current_humidity, current_weather_code)
