...
More updates 
I added dimming so you can auto dim the display between x times you can set how dim it gets and when it starts and ends or you can leave the dimming off
